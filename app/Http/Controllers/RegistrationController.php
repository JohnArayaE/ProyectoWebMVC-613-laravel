...
class RegistrationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'rol'                => 'required|in:PASAJERO,CHOFER,ADMIN',
        ]);
        ...
        try {
            ...
            return redirect()
                ->route('login')
                ->with('success', 'Registro exitoso. Revisá tu correo para activar tu cuenta.');
            ...
            return back()
                ->with('error', 'Ocurrió un error al registrarte. Intenta nuevamente.')
                ->withInput();
        }
    }
